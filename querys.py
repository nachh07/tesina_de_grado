...
D_Clientes = "CREATE TABLE dbo.D_Clientes ( id_cliente INT IDENTITY(1,1) NOT NULL, cod_cliente VARCHAR(7), nombre VARCHAR(50) NOT NULL, apellido VARCHAR(50) NOT NULL, provincia VARCHAR(50) NOT NULL, edad INT NOT NULL, genero VARCHAR(10), CONSTRAINT [PK_Clientes_id_cliente]  PRIMARY KEY NONCLUSTERED  (id_cliente) )"
